...
class Admin_Notices {
    ...
    private function print_license_activate_message( $url ) {
        ?>
            ...
            <div class="error">
                <?php 
                    echo sprintf( '<p>Thank you for purchasing <b>Premium Addons Pro!</b><br><span>Please <a href="%s">activate your license key</a> to get updates, premium support and to enable Premium Templates and white labeling.</span></p>',
                    $url );
                ?>
            </div>

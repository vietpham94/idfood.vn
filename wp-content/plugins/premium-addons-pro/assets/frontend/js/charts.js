                ...
                t.controllers.bar = t.DatasetController.extend({
                    ...
                    calculateBarIndexPixels: function (t, e, i) {
                        var n, a, r, s, l, u, d, c, h, f, g, p, m, v, b, x, y, k = i.scale.options,
                            w = "flex" === k.barThickness ? (h = e, g = k, m = (f = i).pixels, v = m[h], b = h > 0 ? m[h - 1] : null, x = h < m.length - 1 ? m[h + 1] : null, y = g.categoryPercentage, null === b && (b = v - (null === x ? f.end - v : x - v)), null === x && (x = v + v - b), p = v - (v - b) / 2 * y, {
                            ...
                            S = w.start + w.chunk * M + w.chunk / 2,
                            C = Math.min(o.valueOrDefault(k.maxBarThickness, 1 / 0), w.chunk * w.ratio);
                        return {
                            base: S - C / 2,
                            head: S + C / 2,
                            center: S,
                    ...
                    update: function (t) {
                        ...
                        if (f < 2 * Math.PI) {
                            var g = a.rotation % (2 * Math.PI),
                                ...
                                w = g <= -Math.PI && -Math.PI <= p || g <= Math.PI && Math.PI <= p,
                                M = g <= .5 * -Math.PI && .5 * -Math.PI <= p || g <= 1.5 * Math.PI && 1.5 * Math.PI <= p,
                                S = h / 100,
                                C = w ? -1 : Math.min(m * (m < 0 ? 1 : S), b * (b < 0 ? 1 : S)),
                                _ = M ? -1 : Math.min(v * (v < 0 ? 1 : S), x * (x < 0 ? 1 : S)),
                ...
                update: function (t, e, i) {
                    if (t) {
                        ...
                        n.each(h.concat(f, g, p), function (t) {
                            ...
                            i ? (e = t.update(t.fullWidth ? v : w, k), M -= e.height) : (e = t.update(y, M), w -= e.width), S.push({
                                horizontal: i,
                                minSize: e,
                                box: t
                            })
                        ...
                        n.each(h.concat(f), N), n.each(h, function (t) {
                            ...
                            e && t.update(e.minSize.width, M, i)
                        ...
                        var B = l + O,
                            W = d + R;
                        n.each(h.concat(g), V), B += w, W += M, n.each(f, V), n.each(p, V), t.chartArea = {
                            left: P,
                            top: T,
                            right: P + w,
                            bottom: T + M
                    ...
                    function N(t) {
                        ...
                        if (e)
                            if (t.isHorizontal()) {
                                ...
                                t.update(t.fullWidth ? v : w, b / 2, i)
                            } else t.update(e.minSize.width, M)
                    }

                    function V(t) {
                        t.isHorizontal() ? (t.left = t.fullWidth ? l : P, t.right = t.fullWidth ? e - u : P + w, t.top = W, t.bottom = W + t.height, W = t.bottom) : (t.left = B, t.right = B + t.width, t.top = T, t.bottom = T + M, B = t.right)
                    }
                }
            }
        }, {
                        ...
                        if (u.display && h) {
                            ...
                            if (f) {
                                ...
                                var k = o.toRadians(t.labelRotation),
                                    w = Math.cos(k),
                                    M = Math.sin(k) * v + g.size * b + x * (b - 1) + x;
                                n.height = Math.min(t.maxHeight, n.height + M + y), t.ctx.font = g.font;
                                var S = e(t.ctx, a[0], g.font),
                                    C = e(t.ctx, a[a.length - 1], g.font);
                                0 !== t.labelRotation ? (t.paddingLeft = "bottom" === l.position ? w * S + 3 : w * x + 3, t.paddingRight = "bottom" === l.position ? w * x + 3 : w * C + 3) : (t.paddingLeft = S / 2 + 3, t.paddingRight = C / 2 + 3)
                        ...
                        if (a.display) {
                            ...
                            if (o.each(m, function (i, n) {
                                    if (!o.isNullOrUndef(i.label)) {
                                        var r, s, c, f, v, b, x, y, w, M, S, F, O, R, L = i.label;
                                        ...
                                        if (p) {
                                            ...
                                            V < e.left && (s = "rgba(0,0,0,0)"), V += o.aliasPixel(r), O = e.getPixelForTick(n) + d.labelOffset, v = x = w = S = V, b = A, y = T, M = t.top, F = t.bottom + D
                                        } else {
                                            ...
                                            j < e.top && (s = "rgba(0,0,0,0)"), j += o.aliasPixel(r), R = e.getPixelForTick(n) + d.labelOffset, v = I, x = P, w = t.left, S = t.right + D, b = y = M = F = j
                                        }
                                        _.push({
                                            tx1: v,
                                            ty1: b,
                                ...
                                s.save(), s.translate(F, O), s.rotate(R), s.textAlign = "center", s.textBaseline = "middle", s.fillStyle = w, s.font = M.font, s.fillText(f.labelString, 0, 0), s.restore()
                            }
                            if (h.drawBorder) {
        ...
        35: [function (t, e, i) {
            ...
            n._set("global", {
                ...
                t.Tooltip = a.extend({
                    ...
                    update: function (e) {
                        var i, n, a, s, l, u, d, c, h, f, g, p, m, v, b, x, y, k, w, M, S = this,
                            C = S._options,
                            _ = S._model,
                            D = S._model = r(C),
                            I = S._active,
                        ...
                        if (I.length) {
                            ...
                            var z = [];
                            for (i = 0, n = I.length; i < n; ++i) z.push((x = I[i], y = void 0, k = void 0, void 0, void 0, y = x._xScale, k = x._yScale || x._scale, w = x._index, M = x._datasetIndex, {
                                xLabel: y ? y.getLabelForIndex(w, M) : "",
                                yLabel: k ? k.getLabelForIndex(w, M) : "",
                                index: w,
                                datasetIndex: M,
                                x: x._model.x,
                                y: x._model.y
                    ...
                    if (m ? (p.width = t.maxWidth, p.height = a ? 10 : 0) : (p.width = a ? 10 : 0, p.height = t.maxHeight), a)
                        if (r.font = f, m) {
                            ...
                            o.each(t.legendItems, function (t, e) {
                                ...
                                M + S > p.height && (k += w + i.padding, y.push(w), w = 0, M = 0), w = Math.max(w, n), M += S, g[e] = {
                                    left: 0,
                                    top: 0,
                                    width: n,
                                    height: d
                ...
                draw: function () {
                    ...
                    if (e.display) {
                        ...
                        o.each(t.legendItems, function (n, l) {
                            var f, p, m, v, w, M = c.measureText(n.text).width,
                                S = b + g / 2 + M,
                                C = d.x,
                                _ = d.y;
                            y ? C + S >= s && (_ = d.y += k, d.line++, C = d.x = t.left + (s - u[d.line]) / 2) : _ + k > t.bottom && (C = d.x = C + t.columnWidths[d.line] + i.padding, _ = d.y = t.top + i.padding, d.line++),
                                ...
                                }(C, _, n), x[l].left = C, x[l].top = _, f = n, p = M, v = b + (m = g / 2) + C, w = _ + m, c.fillText(f.text, v, w), f.hidden && (c.beginPath(), c.lineWidth = 2, c.moveTo(v, w), c.lineTo(v + p, w), c.stroke()), y ? d.x += S + i.padding : d.y += k
                        })
                    }
                },
                handleEvent: function (t) {
            ...
            var l = a.extend({
                ...
                draw: function () {
                    ...
                    if (a.display) {
                        ...
                        var k = a.text;
                        if (o.isArray(k))
                            for (var w = 0, M = 0; M < k.length; ++M) e.fillText(k[M], 0, w, s), w += g;
                        ...
                        buildTicks: function () {
                            var t = this,
                                ...
                                o = t.ticks = function (t, e) {
                                    ...
                                    do {
                                        o.push(s), 10 == ++a && (a = 1, d = ++i >= 0 ? 1 : d), s = Math.round(a * Math.pow(10, i) * d) / d
                                    } while (i < l || i === l && a < u);
                                    var c = r(t.max, s);
                                    return o.push(c), o
                                }(a, t);
                ...
                var e = t.Scale.extend({
                    ...
                    buildTicks: function () {
                        ...
                        switch (M.ticks.source) {
                            ...
                            case "auto":
                            default:
                                C = m(k, w, y.getLabelCapacity(k), M)
                        }
                        for ("ticks" === M.bounds && C.length && (k = C[0], w = C[C.length - 1]), k = g(S.min, y) || k, w = g(S.max, y) || w, t = 0, e = C.length; t < e; ++t)(i = C[t]) >= k && i <= w && _.push(i);
                        return y.min = k, y.max = w, y._unit = S.unit || function (t, e, i, a) {
                                ...
                                return u
                            }(y._timestamps.data, k, w, M.distribution), y._offsets = (a = y._table, o = _, r = k, s = w, b = 0, x = 0, (d = M).offset && o.length && (d.time.min || (c = o.length > 1 ? o[1] : s, v = o[0], b = (h(a, "time", c, "pos") - h(a, "time", v, "pos")) / 2), d.time.max || (c = o[o.length - 1], v = o.length > 1 ? o[o.length - 2] : r, x = (h(a, "time", c, "pos") - h(a, "time", v, "pos")) / 2)), {
                                left: b,
                                right: x

(function ($) {
    ...
    if ($('.premium-parallax-yes').length) {
        ...
        function premiumParallaxHandler($scope) {
            ...
            function generatePreviewSettings() {
                ...
                if ("multi" !== settings.type && "automove" !== settings.type) {
                    ...
                    settings.positiont = previewSettings["positiont"];
                    settings.positionm = previewSettings["positionm"];
            ...
            function generateJarallax() {
                ...
                if ('tablet' === currentDevice) {
                    settings.position = settings.positiont;
                } else if ('mobile' === currentDevice) {
                    settings.position = settings.positionm;
                }
                    ...
                    if (null !== layout["premium_parallax_layer_image"]["url"] && "" !== layout["premium_parallax_layer_image"]["url"]) {
                        ...
                        var backgroundImage = layout["premium_parallax_layer_image"]["url"],
                            ...
                            $html = $(
                                ...
                                mouseParallax +
                                mouseRate +
                                ' class="premium-parallax-layer"><img class="premium-parallax-img" src="' + backgroundImage + '" alt="' + alt + '"></div>'
                            )
                                .prependTo(target)
                                .css({
                                    "z-index": layout["premium_parallax_layer_z_index"],
                                    "background-size": layout["premium_parallax_layer_back_size"],
                                    "left": layout["premium_parallax_layer_hor_pos" + deviceSuffix]["size"] + "%",
                                    "top": layout["premium_parallax_layer_ver_pos" + deviceSuffix]["size"] + "%",
                                    "width": layout["premium_parallax_layer_width" + deviceSuffix]["size"] + "%"
                                });

...
class Premium_Magic_Section extends Widget_Base {
    ...
    protected function _register_controls() {
        ...
        $this->add_responsive_control('prmium_magic_section_float_img_size',
            [
                'label'         => __('Size','premium-addons-pro'),
                'type'          => Controls_Manager::SLIDER,
                'size_units'    => ['px', "em"],
...
<div class="premium-magic-section-container">
        ...
        <?php if($section_pos == 'top' || $section_pos == 'left') : ?>
            <div class="premium-magic-section-content-wrap-out">
                ...
                <?php if( $settings['premium_magic_section_content_type'] == 'editor') : echo $settings['premium_magic_section_content']; else: echo $this->getTemplateInstance()->get_template_content( $template ); endif; ?>
                </div>        
            </div>
        ...
        <?php elseif($settings['premium_magic_section_trig_selector'] === 'button') : ?>
            <button type="button" class="premium-magic-section-btn btn"><?php if($settings['premium_magic_section_icon_switcher'] && $settings['premium_magic_section_icon_position'] == 'before' && !empty($settings['premium_magic_section_button_icon_selection'])) : ?><i class="premium-magic-btn-icon fa <?php echo esc_attr($button_icon); ?>"></i><?php endif; ?><span class="premium-magic-btn-text"><?php echo $settings['premium_magic_section_button_text']; ?></span><?php if($settings['premium_magic_section_icon_switcher'] && $settings['premium_magic_section_icon_position'] == 'after' && !empty($settings['premium_magic_section_button_icon_selection'])) : ?><i class="premium-magic-btn-icon fa <?php echo esc_attr($button_icon); ?>"></i><?php endif; ?></button>
        <?php endif;?>
        </div>
        <?php endif; ?>

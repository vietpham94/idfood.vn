...
class Premium_Ihover extends Widget_Base {
    ...
    protected function _register_controls() {
        ...
        $this->add_control('premium_ihover_link_whole',
            [
        ...
        $this->add_control('premium_ihover_button_text',
            [
        ...
        $this->add_responsive_control('premium_ihover_thumbnail_alignment', 
            [
        ...
        $this->add_control('premium_ihover_icon_fa_updated', 
            [
                'label'         => __('Icon', 'premium-addons-pro'),
        ...
        $this->start_controls_section('premium_ihover_btn_style',
            [
        ...
        $this->add_control('premium_ihover_btn_hover_scale',
            [
        ...
        $this->add_control('premium_ihover_btn_color',
                [
                    'label'         => __('Text Color', 'premium-addons-pro'),
                    'type'          => Controls_Manager::COLOR,
                    'scheme'        => [
        ...
        $this->add_control('premium_ihover_btn_hover_color',
            [
        ...
        $this->add_control('premium_ihover_btn_background',
            [
                'label'         => __('Background Color', 'premium-addons-pro'),
                'type'          => Controls_Manager::COLOR,
                'scheme'        => [
        ...
        $this->add_control('premium_ihover_btn_hover_background',
            [
        ...
        $this->add_control('premium_ihover_btn_radius',
            [
                'label'         => __('Border Radius', 'premium-addons-pro'),
                'type'          => Controls_Manager::DIMENSIONS,
                'size_units'    => ['px', 'em', '%'],
        ...
        $this->add_responsive_control('premium_ihover_btn_margin',
                [
                    'label'         => __('Margin', 'premium-addons-pro'),
                    'type'          => Controls_Manager::DIMENSIONS,
                    'size_units'    => ['px', 'em', '%'],
        ...
        $this->add_responsive_control('premium_ihover_btn_padding',
                [
                    'label'         => __('Padding', 'premium-addons-pro'),
                    'type'          => Controls_Manager::DIMENSIONS,
                    'size_units'    => ['px', 'em', '%'],
    ...
    protected function get_link() {
        ...
        $this->add_render_attribute('link', 'class', $class );
        ...
        <?php if( 'yes' !== $settings['premium_ihover_link_whole'] ) {
    ...
    protected function render() {
        ...
        if( 'yes' === $settings['premium_ihover_icon_fa_switcher'] ) {
            ...
            if( 'icon' === $icon_type ) {
                ...
                $this->add_render_attribute('content_img', [
                ...
                $this->add_render_attribute( 'lottie_icon', [
                    'class' => [
                                    ...
                                    <div class="premium-ihover-content-wrap">
                                        <div class="premium-ihover-title-wrap">
                                            <?php if( 'yes' === $settings['premium_ihover_icon_fa_switcher'] ) : ?>
                                                <?php if( 'icon' === $icon_type ) :
                                                    if ( $is_new || $migrated ) :
                                                        Icons_Manager::render_icon( $settings['premium_ihover_icon_fa_updated'], ['class' => 'premium-ihover-icon', 'aria-hidden' => 'true' ] );
                                                    else: ?>
                                                        <i <?php echo $this->get_render_attribute_string( 'icon' ); ?>></i>
                                                    <?php endif;
                                                elseif( 'image' === $icon_type ) : ?>
                                                    <img <?php echo $this->get_render_attribute_string('content_img'); ?>>
                                                <?php else: ?>
                                                    <div <?php echo $this->get_render_attribute_string( 'lottie_icon' ); ?>></div>
                                                <?php endif; ?>
                                            <?php endif; ?>
                                        ...
                                        <?php if( 'yes' == $settings['premium_ihover_thumbnail_back_description_switcher'] ) : ?>
                                            <div <?php echo $this->get_render_attribute_string('description'); ?>>
                                                <?php echo $settings['premium_ihover_thumbnail_back_description']; ?>
                                            </div>
                                        <?php endif; ?>

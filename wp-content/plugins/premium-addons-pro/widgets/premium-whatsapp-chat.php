    ...
    protected function _register_controls() {
        ...
        $this->add_responsive_control('icon_spacing',
            [
                ...
                'selectors'     => [
                    '{{WRAPPER}}.premium-whatsapp-icon-after .premium-whatsapp-icon-wrap' => 'margin-left: {{SIZE}}px',
                    '{{WRAPPER}}.premium-whatsapp-icon-before .premium-whatsapp-icon-wrap' => 'margin-right: {{SIZE}}px',
                ],
                'separator'     => 'after',
                'condition'     => [
                    'icon_switcher'     => 'yes',

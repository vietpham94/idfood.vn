...
class Premium_Unfold extends Widget_Base {
    ...
    protected function _register_controls() {
        ...
        $this->add_control('premium_unfold_button_icon_updated',
                [
        ...
        $this->add_control('premium_unfold_button_icon_unfolded_updated',
                [
    ...
    protected function get_unfold_button() {
        ...
        <div class="premium-unfold-button-container">
            ...
            <?php if( $settings['premium_unfold_button_icon_switcher'] && $settings['premium_unfold_button_icon_position'] == 'before' ) : ?>
            ...
            <?php if( $settings['premium_unfold_button_icon_switcher'] && $settings['premium_unfold_button_icon_position'] == 'after') : ?>
    ...
    protected function render() {
        ...
        if( $fold_migrated || $fold_is_new ) {
            $button_icon = $settings['premium_unfold_button_icon_updated']['value'];
        } else {
        ...
        if( $unfold_migrated || $unfold_is_new ) {
            $button_icon_unfolded = $settings['premium_unfold_button_icon_unfolded_updated']['value'];
        } else {
            ...
            <div class='premium-unfold-container'>
                <div class='premium-unfold-folder'>
                    ...
                    <div id="premium-unfold-content-<?php echo $this->get_id(); ?>" class="premium-unfold-content toggled">
                        <div <?php echo $this->get_render_attribute_string('premium_unfold_content');  ?>>
                            <?php if( 'editor' === $settings['content_type'] ) : ?>
                                <?php echo $this->parse_text_editor( $settings['premium_unfold_content'] ); ?>
                            <?php else: ?>
                                <?php echo $this->getTemplateInstance()->get_template_content( $settings['content_temp'] ); ?>
                            <?php endif; ?>
                        </div>
                    </div>

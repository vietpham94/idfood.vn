...
class Premium_Yelp_Reviews extends Widget_Base {
    ...
    protected function _register_controls() {
        ...
        $this->add_control('doc_1',
            [
                'type'            => Controls_Manager::RAW_HTML,
                'raw'             => sprintf( __( '%1$s Getting started » %2$s', 'premium-addons-pro' ), '<a href="https://premiumaddons.com/docs/yelp-reviews-widget-tutorial/?utm_source=pa-dashboard&utm_medium=pa-editor&utm_campaign=pa-plugin" target="_blank" rel="noopener">', '</a>' ),
                'content_classes' => 'editor-pa-doc',
            ]
        );
        ...
        $this->add_control('doc_2',
            [
                'type'            => Controls_Manager::RAW_HTML,
                'raw'             => sprintf( __( '%1$s Getting your API Key » %2$s', 'premium-addons-pro' ), '<a href="https://premiumaddons.com/docs/how-to-get-yelp-api-key/?utm_source=papro-dashboard&utm_medium=papro-editor&utm_campaign=papro-plugin" target="_blank" rel="noopener">', '</a>' ),
                'content_classes' => 'editor-pa-doc',
            ]
        );
        ...
        $this->add_control('doc_3',
            [
                'type'            => Controls_Manager::RAW_HTML,
                'raw'             => sprintf( __( '%1$s How to get your business ID » %2$s', 'premium-addons-pro' ), '<a href="https://premiumaddons.com/docs/how-can-i-get-yelp-business-id/?utm_source=papro-dashboard&utm_medium=papro-editor&utm_campaign=papro-plugin" target="_blank" rel="noopener">', '</a>' ),
                'content_classes' => 'editor-pa-doc',
            ]
        );
        ...
        $this->add_control('doc_4',
            [
                'type'            => Controls_Manager::RAW_HTML,
                'raw'             => sprintf( __( '%1$s Check the video tutorial » %2$s', 'premium-addons-pro' ), '<a href="https://www.youtube.com/watch?v=5T-MveVFvns" target="_blank" rel="noopener">', '</a>' ),
                'content_classes' => 'editor-pa-doc',
            ]
        );
    ...
    protected function render() {
        ...
        if ( ! property_exists( $response, 'reviews' ) ) { ?>
            <div class="premium-error-notice">
                <?php echo __('Something went wrong. It seems like the place you selected does not have any reviews','premium-addons-pro'); ?>
            </div>
            <?php delete_transient( $reviews_transient );

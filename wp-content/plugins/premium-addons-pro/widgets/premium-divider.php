...
class Premium_Divider extends Widget_Base {
    ...
    protected function _register_controls() {
        ...
        $this->add_control('content_font_awesome_icon_updated',
            [
        ...
        $this->add_responsive_control('content_size',
            [
                ...
                'condition'     => [
                    'hide_icon' =>  'table-cell',
                    'content_inside_separator'     => ['font_awesome_icon', 'animation']
                ],
                'label_block'   => true,
                'selectors'     => [
        ...
        $this->add_control('separator_content_color',
            [
                ...
                'condition'     => [
                    'hide_icon' =>  'table-cell',
                    'content_inside_separator!'     => ['custom_image', 'animation']
                ],
                'selectors'     => [
                ...
                <div class="premium-separator-wrapper-separator-divider">
                    <div class="premium-separator-wrapper-separator-divider-main-inner">
                        <?php if ( 'yes' == $settings['content_link_switcher'] ) : ?>
                            ...
                            <a class="premium-separator-item-link" href="<?php echo $link_url; ?>" title="<?php echo $settings['content_link_title']; ?>" <?php if( ! empty( $settings['content_url']['is_external'] ) ) : ?>target="_blank"<?php endif; ?><?php if( ! empty( $settings['content_url']['nofollow'] ) ) : ?>rel="nofollow"<?php endif; ?>><?php endif; ?>
                                    ...
                                    <?php if( 'font_awesome_icon' == $settings['content_inside_separator'] ) : ?>
                                        <div class="premium-separator-icon-wrap premium-separator-icon">
                                            <?php if ( $is_new || $migrated ) :
                                                Icons_Manager::render_icon( $settings['content_font_awesome_icon_updated'], [ 'aria-hidden' => 'true' ] );
                                            else: ?>

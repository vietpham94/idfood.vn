...
class Premium_Charts extends Widget_Base {
    ...
    protected function _register_controls() {
        ...
        $data_repeater->add_control('fill_colors_notice',
			[
				'raw' => '<strong>' . __( 'Please note!', 'premium-addons-pro' ) . '</strong> ' . __( 'First/Second Fill Color options used together to add a gradient for all charts except Pie and Dounut, Fill Colors option used to add multiple colors, but please make sure First/Second Color options are cleared.', 'premium-addons-pro' ),
        ...
        $this->add_control('y_axis_min',
            [
                ...
                'type'          => Controls_Manager::NUMBER,
                'description'   => __('Set Y-axis minimum value, this will be overriden if data has a smaller value', 'premium-addons-pro'),
                'condition'     => [
        ...
        $this->add_responsive_control('legend_position',
            [
    ...
    protected function render() {
        ...
        $this->add_render_attribute( 'charts', [

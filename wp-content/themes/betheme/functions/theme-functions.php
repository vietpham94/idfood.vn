			...
			if ($load_more) {
				...
				$output .= '<div class="column one pager_wrapper">';
					$output .= '<div class="pager">';
						...
						if ($paged >1) {
							$output .= '<a class="prev_page" href="'. esc_url(get_pagenum_link($prev)) .'"><img src="/wp-content/themes/betheme/images/icons/icon-left.png" />'. esc_html($translate['prev']) .'</a>';
						}
						...
						if ($paged < $total) {
							$output .= '<a class="next_page" href="'. esc_url(get_pagenum_link($next)) .'">'. esc_html($translate['next']) .'<img src="/wp-content/themes/betheme/images/icons/icon-right.png" /></a>';
						}

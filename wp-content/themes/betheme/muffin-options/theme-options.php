	...
	function mfn_opts_setup(){
		...
		$menu = array(
			...
			'global' => array(
				...
				'sections' 	=> array( 'general', 'logo', 'buttons', 'sliders', 'advanced', 'hooks' ),
			),
		...
		$sections['buttons'] = array(
			...
			'fields' => array(
				...
				array(
					...
					'title' => __('Style', 'mfn-opts'),
					'options' => array(
						'' => array('title' => 'Default', 'img' => MFN_OPTIONS_URI.'img/select/button/default.svg'),
						'flat' => array('title' => 'Flat', 'img' => MFN_OPTIONS_URI.'img/select/button/flat.svg'),
						'round' => array('title' => 'Round', 'img' => MFN_OPTIONS_URI.'img/select/button/round.svg'),
						'stroke' => array('title' => 'Stroke', 'img' => MFN_OPTIONS_URI.'img/select/button/stroke.svg'),
						'custom' => array('title' => 'Custom', 'img' => MFN_OPTIONS_URI.'img/select/button/custom.svg'),
					),
					'class' => 'wide short simple condition',
				),
				...
				array(
					'id' => 'button-theme-info',
					'type' => 'info',
					'title' => __( 'Theme button', 'mfn-opts' ),
					'class' => 'border-top',
				),
				...
				array(
					...
					'type' => 'color',
					'title' => __( 'Color', 'mfn-opts' ),
					'sub_desc' => __( 'Button background is the same as theme color', 'mfn-opts' ),
					'std' => '#ffffff',
				),
				...
				array(
					...
					'sub_desc' => __('px', 'mfn-opts'),
					'disable' => 'line_height',
					'class' => 'preview-font custom',
					'std' => array(
						'size' => 14,
						'weight_style' => '400',
						'letter_spacing' => 0,
				...
				array(
					...
					'sub_desc' => __('px', 'mfn-opts'),
					'class' => 'number preview-border-width custom',
					'param' => 'number',
					'std' => 0,
				),
				...
				array(
					...
					'sub_desc' => __('px', 'mfn-opts'),
					'class' => 'number preview-border-radius custom',
					'param' => 'number',
					'std' => 0,
				),
				...
				array(
					'id' => 'button-custom-default-info',
					'type' => 'info',
					'title' => __( 'Default', 'mfn-opts' ),
					'class' => 'border-top custom',
				),
				...
				array(
					...
					'type' => 'color_multi',
					'title' => __('Background', 'mfn-opts'),
					'class' => 'preview-background custom',
					'alpha' => true,
					'std' => [
						'normal' => '#dbdddf',
						'hover' => '#d3d3d3',
				...
				array(
					...
					'class' => 'preview-border-color custom',
					'std' => [
						'normal' => '',
						'hover' => '',
					],
				...
				array(
					'id' => 'button-custom-highlighted-info',
					'type' => 'info',
					'title' => __( 'Highlighted', 'mfn-opts' ),
					'desc' => __( 'Primary buttons, i.e. shop, contact form', 'mfn-opts' ),
					'class' => 'border-top custom',
				),
				...
				array(
					...
					'type' => 'color_multi',
					'title' => __('Color', 'mfn-opts'),
					'class' => 'preview-color highlighted custom',
					'std' => [
						'normal' => '#ffffff',
						'hover' => '#ffffff',
					],
				...
				array(
					...
					'type' => 'color_multi',
					'title' => __('Background', 'mfn-opts'),
					'class' => 'preview-background highlighted custom',
					'alpha' => true,
					'std' => [
						'normal' => '#0095eb',
						'hover' => '#007cc3',
				...
				array(
					...
					'type' => 'color_multi',
					'title' => __('Border color', 'mfn-opts'),
					'class' => 'preview-border-color highlighted custom',
					'std' => [
						'normal' => '',
						'hover' => '',
					],
				...
				array(
					'id' => 'button-custom-action-info',
					'type' => 'info',
					'title' => __( 'Action button', 'mfn-opts' ),
					'desc' => __( 'Button located in header, next to main menu', 'mfn-opts' ),
					'class' => 'border-top custom',
				),
		...
		$sections['header'] = array(
			...
			'fields' => array(
				...
				array(
					...
					'type' => 'text',
					'title' => __('Height', 'mfn-opts'),
					'sub_desc' => __('default: 250', 'mfn-opts'),
					'desc' => 'px',
					'class' => 'small-text mhb-opt',
					'std' => 250,
				),

				// @deprecated this options will be removed soon

				array(
					'id' => 'minimalist-header-deprecated',
					'type' => 'select',
					'title' => __('Minimalist', 'mfn-opts'),
					'sub_desc' => __('deprecated since 21.9.1', 'mfn-opts'),
					'desc' => __('Please use <b>Height option</b> above and <b>Responsive > Header</b> options to adjust Header height on mobile', 'mfn-opts'),
					'options'	=> array(
		...
		$sections['featured-image'] = array(
			...
			'fields'	=> array(
				...
				array(
					...
					'type' 		=> 'info',
					'title' 	=> '',
					'desc' 		=> __('After making changes on this page please use Force Regenerate Thumbnails plugin. <a target="_blank" href="admin.php?page=be-plugins">Install plugin</a> and <a target="_blank" href="tools.php?page=force-regenerate-thumbnails">Regenerate thumbnails</a>', 'mfn-opts'),
					'class' 	=> 'mfn-info desc',
				),
		...
		$sections['colors-menu'] = array(
			...
			'fields' => array(
				...
				array(
					...
					'type' => 'info',
					'title' => '',
					'desc' => __('Menu icon <span>Responsive, Header Creative, Simple & Empty</span>', 'mfn-opts'),
					'class' => 'mfn-info mhb-opt',
				),

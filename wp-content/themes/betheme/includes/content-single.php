							...
							echo '<div class="section-related-ul '. esc_attr($related_cols) .'">';
								...
								while ($query_related_posts->have_posts()) {
									...
									echo '<div class="desc">';
										...
										echo '<a href="'. esc_url(get_permalink()) .'" class="button button_left has-icon"><span class="button_icon"><i class="icon-layout"></i></span><span class="button_label">'. esc_html($translate['readmore']) .'</span></a>';
									echo '</div>';

								...
								while ($query_related_posts->have_posts()) {
									...
									echo '<div class="column post-related '. esc_attr(implode(' ', get_post_class())).'">';
										...
										echo '<div class="desc">';
											...
											echo '<a href="'. esc_url(get_permalink()) .'" class="button has-icon"><span class="button_icon"><i class="icon-layout"></i></span><span class="button_label">'. esc_html($translate['readmore']) .'</span></a>';
										echo '</div>';
